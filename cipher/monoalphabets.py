...
class MonoAlphabet:
    """
    A MonoAlphabet Object is represents an alphabet used for
    monoalphabetic substitution. It encapsualtes the plaintext
    sequence and ciphertext sequence, provides dictionaries
    suitable for enciphering and deciphering, and offers an
    overloaded __str__ method for easing logging.
    """
